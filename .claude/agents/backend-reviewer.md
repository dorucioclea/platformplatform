...
5. **Optionally ask the Guardian to run validation** (build + test + format + lint) in parallel with your review. Judgment call: for large changes, catch issues early. For small changes, skip
