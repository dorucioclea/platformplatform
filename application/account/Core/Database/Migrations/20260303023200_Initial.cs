...
[Migration("20260303023200_Initial")]
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                one_time_password_hash = table.Column<string>("text", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                modified_at = table.Column<DateTimeOffset>("timestamptz", nullable: true),
                type = table.Column<string>("text", nullable: false),
                provider_type = table.Column<string>("text", nullable: false),
                email = table.Column<string>("text", nullable: true),
                code_verifier = table.Column<string>("text", nullable: false),
                nonce = table.Column<string>("text", nullable: false),
                browser_fingerprint = table.Column<string>("text", nullable: false),
                login_result = table.Column<string>("text", nullable: true)
            },
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                avatar = table.Column<string>("jsonb", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                created_at = table.Column<DateTimeOffset>("timestamptz", nullable: false),
                modified_at = table.Column<DateTimeOffset>("timestamptz", nullable: true),
                refresh_token_jti = table.Column<string>("text", nullable: false),
                previous_refresh_token_jti = table.Column<string>("text", nullable: true),
                refresh_token_version = table.Column<int>("integer", nullable: false),
                login_method = table.Column<string>("text", nullable: false),
                device_type = table.Column<string>("text", nullable: false),
                user_agent = table.Column<string>("text", nullable: false),
                ip_address = table.Column<string>("text", nullable: false),
                revoked_at = table.Column<DateTimeOffset>("timestamptz", nullable: true),
                revoked_reason = table.Column<string>("text", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey("fk_subscriptions_tenants_tenant_id", x => x.tenant_id, "tenants", "id");
            }
        );
