...
function Switch({ className, ...props }: SwitchPrimitive.Root.Props) {
  return (
    <span className="relative inline-flex [&>input]:hidden">
      <SwitchPrimitive.Root
        ...
        className={cn(
          ...
          // Wrapped in a <span> because BaseUI renders a hidden <input> as a sibling that can affect parent flex layout.
